...
- Si los 3 bugs restantes (005, 009, 010) quedan todos como follow-ups, la Story 14.13 puede pasar a sign-off Outcome A con la lista de follow-ups documentada en §7 del checklist (`docs/planning/epic-14/epic-14-qa-checklist.md`).
...
- `docs/planning/epic-14/epic-14-post-release-bugs.md` — status flips + soluciones documentadas + nuevos bugs 008/009/010
- `docs/planning/epic-14/epic-14-qa-checklist.md` — artefacto de Story 14.13 (checklist-production phase)
...
- `docs/planning/epic-14/epic-14-post-release-bugs.md` — los nuevos BUG-008/009/010 que añadiste + mi actualización de la tabla de triage.
