...
Leyenda de severidad (alineada con `docs/planning/epic-14-post-release-bugs.md`): `blocker` · `high` · `medium` · `low` · `polish`.
...
Pre-registered from `docs/planning/epic-14-post-release-bugs.md:34–50`. MUST be re-tested as part of §3.1 "Post-save navigation shows combinations".
