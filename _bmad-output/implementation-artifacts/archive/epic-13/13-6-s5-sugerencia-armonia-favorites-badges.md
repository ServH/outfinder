...
- Story 13.5 — `_bmad-output/implementation-artifacts/archive/epic-13/13-5-s4-tu-look-skia-composition-share.md` — `drawPolaroidStack`, `ArmarioTuLookScreen` patterns, test baseline, Reviewer Notes structure.
- Story 13.4b — `_bmad-output/implementation-artifacts/archive/epic-13/13-4b-armario-picker-assignment-mechanics.md` — S3 picker route contract + unfavorite cascade pattern.
- Story 13.4a — `_bmad-output/implementation-artifacts/archive/epic-13/13-4a-zero-state-ficha-wada-shared-components.md` — `CompletenessBadge`, `PolaroidCard` props + i18n `armario.badge.*` keys.
